...
def main():
  ...
  train_data = torchfcn.datasets.SBDClassSeg(root, split='train', transform=True)
  train_loader = torch.utils.data.DataLoader(train_data, batch_size=1, shuffle=True, **kwargs)
  val_data = torchfcn.datasets.VOC2011ClassSeg(root, split='seg11valid', transform=True)
